 ...
 */
public abstract class NanoHTTPDold {
    /**
     ...
     */
    public NanoHTTPDold(String hostname, int port) {
    ...
    public static class DefaultTempFile implements TempFile {
        ...
        public DefaultTempFile(String tempdir) throws IOException {
            file = File.createTempFile("NanoHTTPDold-", "", new File(tempdir));
