...
public class CTstream implements ActionListener,ChangeListener,MouseMotionListener {
	...
	public CTstream(String[] argsI) {
	    ...
	    // Channel name
	    screencapStreamName = line.getOptionValue("c", screencapStreamName);
	    // Auto-flush time
	    try {
	    ...
	    bAudiocap = line.hasOption("audio_cap");
	 ...
	 * startWriteTask
	 *
	 * Create a new WriteTask which grabs data off the various DataStream queues and writes them to CT.
	 * Run this in a new thread.
	 * Note that we only start a new WriteTask if there is no audio capture; if there is audio capture,
	 * images are written out in AudioStream thread.
	 */
