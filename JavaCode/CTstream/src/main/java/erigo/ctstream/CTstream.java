 ...
 * 2. CTsettings: dialog to allow the user to edit settings
 ...
 * 4. DataStream: abstract class which is extended by each class implementing a data source
 * 5. ScreencapStream: extends DataStream; performs periodic screen captures
 * 6. AudiocapTask: captures audio WAV data
 * 6. TimeValue: a data sample to be sent to CloudTurbine, made up of byte array and a timestamp;
 ...
 * 8. WriteTask: handles all CloudTurbine API calls
 * 9. Utility: utility methods
 *
 * GUI notes
 * ---------
